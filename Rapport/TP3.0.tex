...
Les defines sont un ensemble de classes ("DefinePath" et "DefineConstant") qui permettent de centraliser les valeurs constantes utilisés dans le code du programme afin de faciliter les modifications éventuelles.
