...
Pour ce projet, totalement adapté, avec un sprint entre chaque réunion de groupe avec les tuteurs. MétaCiv étant déjà existant, dès les premières réunions nous avons pu présenter des modélisations ainsi que pointer du doigts certains problèmes, pour s'organiser pour les résoudre et également redéfinir les objectifs soulevés par sujet.

\subsection{Déroulement du Projet}

Ce projet avait de part ça nature quelque chose de spécial. En effet il s'agissait à la base d'un sujet de modélisation assez libre sur laquelle nos envies étaient les seules limites. Par la suite, nous avons du considérer la restriction technique causé par le logiciel MetaCiv, mais il reste que le sujet était sans grosses contrainte par rapport à d'autres plus conventionnel. Et pour une gestion d'un tel projet, la structuration et l'organisation s'avère moins dense.\\

Il n'empêche que l'utilisation de la méthode Agile était très efficace (et indiqué) avec des sprints de une à deux semaines qui permettaient de montrer les avancer et d'indiquer les besoins, tout en redéfinissant les objectifs par rapport aux problèmes rencontrés!
Dans un premier temps, les quatre membres devaient participer au développement des modèles de civilisations, mais dans ensuite le projet a bifurqué pour des contraintes de logiciel, et François Suro s'est donc occupé des corrections des bugs de MetaCiv ainsi que l?ajout de nouvelles fonctions.Lionel s'occupait aussi de toute la partie coordination et gestion de Git, en s?occupant des merges en plus de sa partie de modélisation.\\

Le programme MetaCiv  est un projet qui a été développé par des groupes successifs d'étudiant. Développé autour de turtlekit et madkit , le programme possède une base solide , mais les ajouts successifs de fonctionnalités sans respect de normes et de méthodes on conduit à un logiciel instable et un code source chaotique.\\

Nos premières expériences de modélisation , qui se soldaient par des modèles corrompus et donc des heures de travail perdus , nous ont vite amené à la décision d'utiliser une partie de nos ressource à rendre le programme plus stable.\\

Une fois cette étape atteinte , et le risque de perdre le travail effectué écarté , nous avons conservé cette séparation des tâches pour la correction des nombreux bugs , le groupe de modélisation relayant à travers Trello les protocoles de reproduction de bugs au groupe de développement.\\

Les ambitions du projets ont donc été revu à la baisse pour des raisons techniques et une grande partie du sujet final a été l'amélioration du logiciel.
Lors de nos réunions hebdomadaires , le groupe de modélisation présentait son avancée et les problèmes rencontrés , surtout au niveau conceptuel , et avec les conseils de Mr Ferber et Mr Stratulat , nous mettions au point des solutions qui permettent de pousser la modélisation plus loin.\\

Enfin , dès qu'un moment de libre se présentait , nous avons fait un travail d'amélioration de l'interface , pour la rendre plus claire et plus agréable à l'utilisation.\\

En somme , le développement à été conduit par les besoins de l?équipe de modélisation.
De plus, les avancées du logiciel servaient également à un deuxième groupe, des Demi Octet, dans leurs projet basé sur le même moteur. Nous avons décider de garder les deux branches de de code les plus proche l'une de l'autre histoire que toute l'avancer technique soit bénéfique pour les deux équipes. Ce dernier point donna également plus de travail à Lionel Ferrand, responsable de la compatibilité des versions, dont les compétences furent mise à disposition des deux groupes.
La partie développement a aussi prit une plus grosse place que prévu, dans laquelle nous avons essayé , lors de l?ajout de fonctionnalités , de produire un code plus clair , en séparant bien chaque chose (éviter les fonctions de plusieurs centaines de ligne), en utilisant une approche plus objet et en utilisant quelques design patterns.
Ayant sous évalué ou même oublié les points si dessus, la portée de la partie modélisation fut revus à la baisse.
...
Le développement des avancés  de MetaCiv, nous avons utilisé GitHub,  un logiciel de gestion de versions décentralisé aidant au développement grâce au gestion de versions Git. Sur ce site nous pouvons facilement partager du code, en gérant les conflits, par la création de diverse branche. Grâce à ce programme nous avons pu garder une proche parenté entre les deux projets frères que sont MétaCiv et CivCraft.
