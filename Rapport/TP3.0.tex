...
\caption{Application système de subsomption : les besoins essentiels sont évalués à la première étape comme la faim ou le sommeil, si ces besoins sont satisfaits, le cogniton satisfait prends le dessus et déclenche le mode 2 qui évalue des actions plus complexes}
\end{figure} 
